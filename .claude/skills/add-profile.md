...
2. Check if `test-kitchen/test-kitchen/profiles/<name>.md` already exists — if so, read it and show current settings
3. Ask about:
...
4. Write `test-kitchen/test-kitchen/profiles/<name>.md` following the format in `test-kitchen/test-kitchen/profiles/README.md`
5. Commit and push
