...
3. Read `test-kitchen/test-kitchen/reviews/ratings.md` for feedback
4. Read the most recent file in `test-kitchen/plans/` to avoid repeating the same lineup
...
7. Generate `test-kitchen/plans/week-NN.md` following the simplified format in AGENTS.md:
